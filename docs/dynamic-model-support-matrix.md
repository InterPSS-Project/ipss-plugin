...
to TGOV1. DC4B, ST1C, ESST2A, ST2C, ST3C, and ST4C have hash-repeatable direct PowerWorld contracts for
the approved ESDC4B, ESST1C, ESST2A/EXST2A, ESST2C, ESST3C, and ESST4C rows. The validated inventory is 73 artifacts,
including `47/64` approved exciter rows and `23/24` approved PSS/E governor rows with
