...
to TGOV1. DC4B, ST1C, ESST2A, ST2C, and ST3C have hash-repeatable direct PowerWorld contracts for
the approved ESDC4B, ESST1C, ESST2A/EXST2A, ESST2C, and ESST3C rows. The validated inventory is 72 artifacts,
including `46/64` approved exciter rows and `23/24` approved PSS/E governor rows with
