...
to TGOV1. DC4B, ST1C, ESST2A, ST2C, ST3C, ST4C, and ST5B have hash-repeatable direct PowerWorld contracts for
the approved ESDC4B, ESST1C, ESST2A/EXST2A, ESST2C, ESST3C, ESST4C, and ESST5B rows. The validated inventory is 74 artifacts,
including `48/64` approved exciter rows and `23/24` approved PSS/E governor rows with
