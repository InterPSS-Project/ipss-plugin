...
to TGOV1. DC4B has a hash-repeatable direct six-state PowerWorld contract for
the approved ESDC4B row. The validated inventory is 68 artifacts, including
`41/64` approved exciter rows and `23/24` approved PSS/E governor rows with
