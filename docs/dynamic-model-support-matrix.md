...
to TGOV1. DC4B, ST1C, ESST2A, and ST2C have hash-repeatable direct PowerWorld contracts for
the approved ESDC4B, ESST1C, ESST2A/EXST2A, and ESST2C rows. The validated inventory is 71 artifacts,
including `45/64` approved exciter rows and `23/24` approved PSS/E governor rows with
