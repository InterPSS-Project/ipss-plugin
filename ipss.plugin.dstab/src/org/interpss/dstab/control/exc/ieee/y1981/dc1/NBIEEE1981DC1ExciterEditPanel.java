...
public class NBIEEE1981DC1ExciterEditPanel extends javax.swing.JPanel implements ICustomPluginEditor {
	...
	IEEE1981DC1ExciterData _data;

    /** Creates new form FaultLocDataPanel */
    public NBIEEE1981DC1ExciterEditPanel() {
        initComponents();
	...
	public void init(Object controller) {
		...
		_data = ((IEEE1981DC1Exciter)controller).getData();
	}
	...
	*/
    public boolean setData2Editor(String desc) {
  	    ...
  	    taTextField.setText(Number2String.toStr(_data.getTa(), "#0.000"));
            ...
            efd1TextField.setText(Number2String.toStr(_data.getE1(), "#0.000"));
	...
	*/
	...
	if (SwingInputVerifyUtil.within(this.efd1TextField, 0.001, 100.0, errMsg,
			"E1 is out of the range [0.001, 100.0]"))
		_data.setE1(SwingInputVerifyUtil.getDouble(efd1TextField));
	//TODO need to specify e2 for SE2? 
       _data.setE2(SwingInputVerifyUtil.getDouble(efd1TextField)*0.75);
