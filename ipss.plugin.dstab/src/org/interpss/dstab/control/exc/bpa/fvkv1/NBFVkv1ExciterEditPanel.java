...
public class NBFVkv1ExciterEditPanel extends javax.swing.JPanel implements ICustomPluginEditor {
	private static final long serialVersionUID = 1;

	// define data to be edited
	FVkv1ExciterData _data;

    /** Creates new form FaultLocDataPanel */
    public NBFVkv1ExciterEditPanel() {
        initComponents();
	...
	public void init(Object controller) {
		...
		_data = ((FVkv1Exciter)controller).getData();
	}
