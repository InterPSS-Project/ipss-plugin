 ...
 */
     ...
     */
	public BPASSTypeStabilizer(final String id, final String name, final String caty) {
            super(id, name, caty);
            // _data is defined in the parent class. However init it here is a MUST
            _data = new BpaSSTypeStabilizerData();
	}
 ...
 */
     ...
     */
    public BpaSSTypeStabilizerData getData() {
        return (BpaSSTypeStabilizerData)_data;
    }
