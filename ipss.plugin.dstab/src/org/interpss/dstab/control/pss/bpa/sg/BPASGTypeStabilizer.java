...
package org.interpss.dstab.control.pss.bpa.sg;
 ...
 */
     ...
     */
	public BPASGTypeStabilizer(final String id, final String name, final String caty) {
            super(id, name, caty);
            // _data is defined in the parent class. However init it here is a MUST
            _data = new BpaSGTypeStabilizerData();
	}
 ...
 */
     ...
     */
    public BpaSGTypeStabilizerData getData() {
        return (BpaSGTypeStabilizerData)_data;
    }
