...
public class NBBpaEaTypeExciterEditPanel extends javax.swing.JPanel implements ICustomPluginEditor {
	private static final long serialVersionUID = 1;

	// define data to be edited
	BpaEaTypeExciterData _data;

    /** Creates new form FaultLocDataPanel */
    public NBBpaEaTypeExciterEditPanel() {
        initComponents();
	...
	public void init(Object controller) {
		...
		_data = ((BpaEaTypeExciter)controller).getData();
	}
