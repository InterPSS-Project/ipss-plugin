...
├── GEFormat                       # EPC facade → EpcDirectParser
...
| `GEAdapterTestSuite` | Fast EPC subset: Sample18Bus facade+DirectParser, section gates, UCTE_2002_Summer smoke, unit SHUNT/PS, local Texas2k and ACTIVSg10k RAW comparisons |
...
EPC section coverage (`EpcDirectParser`):
