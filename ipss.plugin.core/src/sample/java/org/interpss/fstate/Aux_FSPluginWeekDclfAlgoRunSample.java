...
public class Aux_FSPluginWeekDclfAlgoRunSample {
    public static void main(String[] args) throws Exception {
        AclfNetwork aclfNet = IEEE39_RAW_Info_Sample.loadIEEE39Raw();

        Path weekDir = Path.of("ipss.plugin.core/testData/powerworld/ieee39/week");
        PlanMaintainModel model = Aux2PlanMaintainAdapter.createWeekModel(weekDir);
        ...
        System.out.println(" DCLF week: periods=" + model.getNumsOfPeriods()
