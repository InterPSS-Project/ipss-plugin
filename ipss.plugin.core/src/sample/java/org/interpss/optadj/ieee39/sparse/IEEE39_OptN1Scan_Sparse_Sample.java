...
public class IEEE39_OptN1Scan_Sparse_Sample {
	...
	public static void main(String args[]) throws Exception {
		...
		Map<String, OptAdjResultContainer.GenAdjustResult> results = new AclfNetContigencyOptimizer(true).optimize(dclfAlgo, null, 100.0);
