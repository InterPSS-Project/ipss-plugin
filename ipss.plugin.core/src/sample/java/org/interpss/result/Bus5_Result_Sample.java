...
public class Bus5_Result_Sample {
	public static void main(String args[]) throws Exception {
		...
		AclfResultContainer results = new AclfResultAdapter().accept(net);
  		...
  		// Print DataFrames
  		System.out.println("=== Net Info DataFrame ===");
  		System.out.println(netDf);
  		System.out.println("\n=== Bus Info DataFrame ===");
  		System.out.println(busDf);
  		System.out.println("\n=== Branch Info DataFrame ===");
  		System.out.println(branchDf);
  		System.out.println("\n=== Gen Info DataFrame ===");
  		System.out.println(genDf);
	}
