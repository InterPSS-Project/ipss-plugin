...
public class IEEE2005ST3AExciterData {
	
	private double tr = 0;
	private double Vimax = 0.2;
	private double Vimin = -0.2;
	private double ka = 200;
	private double ta = 0;
	private double tb = 6.67;
	private double tc =1.0;
	private double Vrmax =10.0;
	private double vrmin =-10.0;
	private double Km = 7.04;
	private double Tm = 1.0;
	private double Vmmax =1.0;
	private double Vmmin = 0;
	private double Kg  = 1.0;
	private double Kp  = 4.37;
	private double angKp = 20.0; // deg
	private double Ki = 4.83;    // current source gain
	...
	private double Vgmax = 6.53; // maximum inner loop feedback voltage
	...
	public void setVmmax(double vmmax) {
		Vmmax = vmmax;
	}
	public double getVmmin() {
		return Vmmin;
	}
	public void setVmmin(double vmmin) {
		Vmmin = vmmin;
	}
	public double getKg() {
		return Kg;
	...
	public double getAngKp() {
		return angKp;
	}
	public void setAngKp(double angKp) {
		this.angKp = angKp;
	}
	public double getKi() {
		return Ki;
	...
	public void setVgmax(double vgmax) {
		Vgmax = vgmax;
	}
