...
public class NBBpaEkTypeExciterEditPanel extends javax.swing.JPanel implements ICustomPluginEditor {
	private static final long serialVersionUID = 1;

	// define data to be edited
	BpaEkTypeExciterData _data;

    /** Creates new form FaultLocDataPanel */
    public NBBpaEkTypeExciterEditPanel() {
        initComponents();
	...
	public void init(Object controller) {
		...
		_data = ((BpaEkTypeExciter)controller).getData();
	}
	...
	*/
    public boolean setData2Editor(String desc) {
  	    ...
  	    taTextField.setText(Number2String.toStr(_data.getTa(), "#0.000"));
            ...
            semaxTextField.setText(Number2String.toStr(_data.getSe_e1(), "#0.000"));
	...
	*/
	...
	if (SwingInputVerifyUtil.within(this.semaxTextField, 0.001, 10.0, errMsg,
		...
		_data.setSe_e1(SwingInputVerifyUtil.getDouble(semaxTextField));
