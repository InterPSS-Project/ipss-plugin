...
/** Native PSS/E IEEE ST7B excitation-system parameters. */
public class St7bData extends BaseControllerData {
    private int oel,uel;
    private double tr,tg,tf,vmax,vmin,kpa,vrmax,vrmin,kh,kl,tc,tb,kia,tia;
    ...
    @Override public void setValue(String name,double value){switch(name.toLowerCase()){
        ...
        case "tc"->tc=value;case "tb"->tb=value;case "kia"->kia=value;case "tia"->tia=value;default->{}}}
