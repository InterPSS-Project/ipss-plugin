...
/** Parameters in the thirty-three-value PSS/E GAST2AD/GAST2ADU record. */
public class PsseGast2adGovernorData extends BaseControllerData {
    private double w, x, y, etd, tcd, trate, t, maxLimit, minLimit, ecr, k3;
    private double a, b, c, tauF, kf, k5, k4, t3, t4, tauT, t5;
    private double af1, bf1, af2, bf2, cf2, tr, k6, tc, dbH, dbL;
    private int z;
    ...
    @Override public void setValue(String name, int value) { if("z".equalsIgnoreCase(name))z=value; else setValue(name,(double)value); }
    @Override public void setValue(String name, double value) {
        switch(name.toLowerCase()) {
            case "w"->w=value; case "x"->x=value; case "y"->y=value; case "z"->z=(int)value;
            ...
            case "dbh"->dbH=value; case "dbl"->dbL=value; default->{ }
        }
    }
}
