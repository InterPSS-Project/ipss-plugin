...
public class ExciterObjectFactory {
	...
	/** Create a native PSS/E IEEEX2 exciter with its second feedback lag. */
	public static Ieeex2Exciter createIeeex2Exciter(String id, Machine machine) {
		return new Ieeex2Exciter(id, machine);
	}
	...
	/** Create a native PSS/E IEEE ST7B excitation system. */
	public static St7bExciter createSt7bExciter(String id,St7bData data,
			Machine machine){return new St7bExciter(id,data,machine);}

	/** Create a native PSS/E IEEE 421.5-2016 ST7C excitation system. */
	public static St7cExciter createSt7cExciter(String id,St7cData data,
			Machine machine){return new St7cExciter(id,data,machine);}

	/** Create a native PSS/E IEEE 421.5-2016 ST8C excitation system. */
	public static St8cExciter createSt8cExciter(String id,St8cData data,
			Machine machine){return new St8cExciter(id,data,machine);}

	/** Create a native PSS/E IEEE 421.5-2016 ST9C excitation system. */
	public static St9cExciter createSt9cExciter(String id, St9cData data,
			Machine machine) { return new St9cExciter(id, data, machine); }

	/** Create a native PSS/E IEEE 421.5-2016 ST10C excitation system. */
	public static St10cExciter createSt10cExciter(String id, St10cData data,
			Machine machine) { return new St10cExciter(id, data, machine); }
