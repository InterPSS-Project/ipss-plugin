...
/** IEEE 421.5-2016 / PSS/E AC1C excitation-system parameters. */
public final class Ac1cData extends BaseControllerData {
    // PSS/E DYR records carry OEL and UEL locations. SCL is retained for the
    // IEEE/PowerWorld typed API and remains unused unless explicitly assigned.
    private int oelLocation, uelLocation, sclLocation;
    private double tr, tb, tc, ka, ta, vamax, vamin, te, kf, tf;
    private double kc, kd, ke, e1, se1, e2, se2, efemax, efemin, vfemax, vemin;
    ...
    public Ac1cData() {
        setRangeParameters(new String[][] {
                ...
                {"vamin", "-10000.0", "10000.0"}, {"te", "0.0", "1000.0"},
                {"kf", "-10000.0", "10000.0"}, {"tf", "0.0", "1000.0"},
                {"kc", "0.0", "10000.0"}, {"kd", "0.0", "10000.0"},
                {"ke", "-10000.0", "10000.0"}, {"e1", "0.0", "10000.0"},
                {"se1", "0.0", "10000.0"}, {"e2", "0.0", "10000.0"},
                {"se2", "0.0", "10000.0"}, {"efemax", "-10000.0", "10000.0"},
                {"efemin", "-10000.0", "10000.0"}, {"vfemax", "-10000.0", "10000.0"},
