...
public class ODMDistNetMapper extends AbstractODMNetDataMapper<DistributionNetXmlType, DistNetwork> {
	public ODMDistNetMapper() {
	}
	 ...
	 */
	@Override
	public DistNetwork map2Model(DistributionNetXmlType p) throws InterpssException {
	 ...
	 */
	@Override
	public boolean map2Model(DistributionNetXmlType xmlNet, DistNetwork distNet) {
