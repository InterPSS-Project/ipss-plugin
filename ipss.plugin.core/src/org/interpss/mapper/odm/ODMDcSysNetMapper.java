...
public class ODMDcSysNetMapper extends AbstractODMNetDataMapper<DcNetworkXmlType, DcNetwork> {
	public ODMDcSysNetMapper() {
	}
	 ...
	 */
	@Override
	public DcNetwork map2Model(DcNetworkXmlType p) throws IpssDcSysException {
...
//		}
	 ...
	 */
	@Override
	public boolean map2Model(DcNetworkXmlType xmlNet, DcNetwork dcNet) {
