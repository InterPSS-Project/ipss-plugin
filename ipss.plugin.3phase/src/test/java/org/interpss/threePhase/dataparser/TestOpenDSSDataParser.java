...
//		}
		...
		//3. test load parser
		    ...
		    */
		  DStab3PBus bus1 = distNet.getBus("1");
		   ...
		   */
		  DStab3PBus bus35 = distNet.getBus("35");
		   ...
		   */
		  DStab3PBus bus48 = distNet.getBus("48");
		  DStab3PLoad ld_s48= bus48.getThreePhaseLoadList().get(0); // only one load
