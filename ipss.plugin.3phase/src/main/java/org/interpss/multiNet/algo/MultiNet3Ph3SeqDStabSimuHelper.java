...
public class MultiNet3Ph3SeqDStabSimuHelper extends AbstractMultiNetDStabSimuHelper{
	...
	public MultiNet3Ph3SeqDStabSimuHelper (BaseDStabNetwork<?,?> net, SubNetworkProcessor subNetProc){
		this.net = net;
	...
	public boolean solveBoundarySubSystem() {
    	...
    	if(this.ZlAry!=null){
    		...
    		//create SparseMatrix3x3 with the ZlAry;
    		 ...
    		 ISparseEqnComplexMatrix3x3 ZlMatrix = new CSJSparseEqnComplexMatrix3x3Impl(dim);
