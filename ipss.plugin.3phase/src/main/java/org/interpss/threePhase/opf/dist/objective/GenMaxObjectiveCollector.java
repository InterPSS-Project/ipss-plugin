...
public class GenMaxObjectiveCollector extends BaseDistOpfObjectiveCollector {

	public GenMaxObjectiveCollector(DistOpfModelData modelData,
	...
	public void collectObjective() {
		for (DistOpfDerData der : modelData.getDers()) {
			for (PhaseCode phase : der.getPhases()) {
				objective[variableIndex.derP(der.getId(), phase)] = -1.0;
			}
		}
	}
}
