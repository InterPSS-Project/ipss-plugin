...
public class ComplexSparseMatrix {
	...
	public static void sample1() {
		ISparseEqnComplex m = new SparseEqnComplexImpl(2,3) ;
	...
	public static void sample2() {
		ISparseEqnComplex m = new SparseEqnComplexImpl(2, 2);
	...
	public static void sample3() throws IpssNumericException {
