...
/**
 * Regression test for {@code Texas2K_OptN1Scan_SsaResult_Sparse_Sample1}: full N-1 branch-outage
 * DCLF scan with SSA over-limit info via {@link AclfNetSsaHelper}, then sparse
 * {@link AclfNetContigencyOptimizer} at 100% contingency loading limit on all branches.
 */
public class Texas2K_OptN1Scan_SsaResult_Sparse_Test1 extends CorePluginTestSetup {
	...
	void n1BranchOutageOptimizerWithSsaResultReducesOverLimitViolations() throws Exception {
		...
		Map<String, OptAdjResultContainer.GenAdjustResult> adjustResults = new AclfNetContigencyOptimizer(true)
		...
		// Regression anchors (Texas2K_OptN1Scan_SsaResult_Sparse_Sample1, 100% limit, all branches).
