...
public class IEEE14_OptAdj_N1ScanSSAResult_Test extends CorePluginTestSetup {
	...
	public void testGenLoad() throws InterpssException {
		...
		// {Gen:Bus3-G1=0.49500000000000055, Load:Bus4-L1=-0.4779999999999998, Load:Bus14-L1=-0.0170000000000008}
		...
		assertEquals(resultMap.get("Load:Bus14-L1"), -0.0170000000000008, 0.0001);
