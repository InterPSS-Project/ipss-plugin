...
/** Full-solver GENROU + AC3C comparison against the PowerWorld reference. */
public class Ac3cPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-ac3c", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "AC3C PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("AC3C PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
