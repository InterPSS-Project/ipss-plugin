...
/** Full-solver GENROU + ESAC1A comparison against the Independent reference. */
public class Esac1aIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterStates() throws Exception {
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("smib-genrou-esac1a");
        ...
        System.out.printf(Locale.ROOT,
                "ESAC1A Independent max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("ESAC1A Independent max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
