...
/** Full-solver native PSS/E DC4C comparison against Independent. */
public class Dc4cIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterSignals()throws Exception{
        ...
        EmbeddedTrajectoryReference reference=EmbeddedTrajectoryReference.embedded("smib-genrou-dc4c");
        ...
        System.out.printf(Locale.ROOT,"DC4C Independent max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g angleDeg=%.9g speed=%.9g eqp=%.9g psiDp=%.9g psiQpp=%.9g edp=%.9g field=%.9g sensedV=%.9g pi=%.9g derivative=%.9g vr=%.9g feedback=%.9g%n",Arrays.stream(maximum).boxed().toArray());
        System.out.println("DC4C Independent max-error times: "+Arrays.toString(maximumTime));
