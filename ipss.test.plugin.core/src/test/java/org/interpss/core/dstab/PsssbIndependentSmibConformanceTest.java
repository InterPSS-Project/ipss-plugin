...
/** Full-solver GENROU + ESST1A + WECC PSSSB comparison against Independent. */
public class PsssbIndependentSmibConformanceTest {
    private static final double STEP = 0.0005;
    private static final Path CASE = Path.of("testData", "adpter", "psse", "v33", "SMIB");

    @Test
    void localizedFaultMatchesIndependentBoundaryAndAllActivePsssbStates()
            throws Exception {
        IpssCorePlugin.init();
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("smib-genrou-esst1a-psssb");
        ...
        System.out.println("PSSSB Independent max errors: " + Arrays.toString(maximum));
        double[] tolerance = {
