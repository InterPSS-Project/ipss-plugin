...
/** Full-solver GENROU + EXAC1A comparison against the PowerWorld reference. */
@org.junit.jupiter.api.Tag("private-reference")
public class Exac1aPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        var context = new PSSEMultiFileLoader().loadDStab(
                ...
                CASE.resolve("SMIB_v33_genrou_exac1a_powerworld.dyr").toString());
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-exac1a", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "EXAC1A PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("EXAC1A PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
