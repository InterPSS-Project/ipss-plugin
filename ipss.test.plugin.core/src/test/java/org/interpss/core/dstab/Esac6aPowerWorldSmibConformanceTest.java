...
/** Full-solver GENROU + ESAC6A comparison against the PowerWorld reference. */
@org.junit.jupiter.api.Tag("private-reference")
public class Esac6aPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        var context = new PSSEMultiFileLoader().loadDStab(
                ...
                CASE.resolve("SMIB_v33_genrou_esac6a_powerworld.dyr").toString());
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-esac6a", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "ESAC6A PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("ESAC6A PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
