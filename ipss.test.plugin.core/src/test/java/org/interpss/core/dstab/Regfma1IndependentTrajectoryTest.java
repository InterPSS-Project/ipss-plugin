...
/** Direct REGFM_A1 nine-state comparison against a reproducible Independent run. */
public class Regfma1IndependentTrajectoryTest extends CorePluginTestSetup {
    private static final double STEP = 0.0005;

    @Test
    void threeCycleTerminalFaultMatchesIndependentStates() throws Exception {
        ...
        assertTrue(algorithm.initialization(), "REGFMA1 Independent benchmark initialization");
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("regfma1-bus1062");
        int[] field = {
        ...
        System.out.printf(Locale.ROOT,
                "REGFMA1 Independent max errors: v3=%.9g v2=%.9g v1=%.9g pMW=%.9g "
