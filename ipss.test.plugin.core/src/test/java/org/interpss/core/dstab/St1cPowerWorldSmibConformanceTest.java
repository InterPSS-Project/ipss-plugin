...
/** Full-solver native PSS/E ST1C comparison against PowerWorld. */
@org.junit.jupiter.api.Tag("private-reference")
public class St1cPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates()throws Exception{
        ...
        PowerWorldCsvReference reference=PowerWorldCsvReference.read(Path.of("testData","reference","powerworld",
                "smib-genrou-st1c","powerworld.csv"));
        ...
        System.out.println("ST1C PowerWorld max errors: "+Arrays.toString(maximum));
        System.out.println("ST1C PowerWorld max-error times: "+Arrays.toString(maximumTime));
