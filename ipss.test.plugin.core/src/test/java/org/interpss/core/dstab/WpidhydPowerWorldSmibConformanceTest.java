...
/** Full-solver GENROU + WPIDHYD comparison against PowerWorld. */
public class WpidhydPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndGovernorStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-wpidhyd", "powerworld.csv"));
        ...
        System.out.println("WPIDHYD PowerWorld max errors: " + Arrays.toString(maximum));
        System.out.println("WPIDHYD PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
