...
/** Full-solver GENROU + native GAST2AD comparison against Independent. */
public class Gast2adIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndGovernorStates() throws Exception {
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("smib-genrou-gast2ad");
        ...
        System.out.println("GAST2AD Independent max errors: " + Arrays.toString(maximum));
        System.out.println("GAST2AD Independent max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
