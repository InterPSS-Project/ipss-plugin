...
/** Full-solver GENROU + TGOV1 + LCFB1 comparison against PowerWorld. */
public class Lcfb1PowerWorldSmibConformanceTest {
    private static final double STEP = 0.0005;
    private static final Path CASE = Path.of("testData", "adpter", "psse", "v33", "SMIB");

    @Test
    void threeCycleFaultMatchesPowerWorldBoundaryGovernorAndPrefControllerStates() throws Exception {
        IpssCorePlugin.init();
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-tgov1-lcfb1",
                "powerworld.csv"));
        ...
        System.out.println("LCFB1 PowerWorld max errors: " + Arrays.toString(maximum));
        System.out.println("LCFB1 PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
