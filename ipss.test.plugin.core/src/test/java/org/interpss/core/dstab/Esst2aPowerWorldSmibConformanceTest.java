...
/** Full-solver native PSS/E ESST2A comparison against PowerWorld. */
public class Esst2aPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates()throws Exception{
        ...
        PowerWorldCsvReference reference=PowerWorldCsvReference.read(Path.of("testData","reference","powerworld",
                "smib-genrou-esst2a","powerworld.csv"));
        ...
        System.out.println("ESST2A PowerWorld max errors: "+Arrays.toString(maximum));
        System.out.println("ESST2A PowerWorld max-error times: "+Arrays.toString(maximumTime));
