...
/** Full-solver GENROU + PIDGOVD comparison against Independent. */
public class PidgovdIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndGovernorStates() throws Exception {
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("smib-genrou-pidgovd");
        ...
        System.out.println("PIDGOVD Independent max errors: " + Arrays.toString(maximum));
        System.out.println("PIDGOVD Independent max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
