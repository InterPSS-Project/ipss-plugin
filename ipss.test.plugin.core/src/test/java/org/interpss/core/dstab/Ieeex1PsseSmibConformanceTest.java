...
/** Native PSS/E 36.7 full-solver trajectory contract for IEEEX1. */
@org.junit.jupiter.api.Tag("private-reference")
public class Ieeex1PsseSmibConformanceTest {
    private static final double STEP = 0.00025;
    private static final Path CASE = Path.of("testData", "adpter", "psse", "v33", "SMIB");
    private static final Path REFERENCE = Path.of(
            "testData", "reference", "psse", "smib-genrou-ieeex1", "psse.csv");
    ...
    void threeCycleFaultMatchesPsseBoundaryAndFiveExciterStates() throws Exception {
        ...
        assertTrue(algorithm.getAclfAlgorithm().loadflow(), "IEEEX1 SMIB load flow");
        ...
        assertTrue(algorithm.initialization(), "IEEEX1 SMIB initialization");
        ...
        assertEquals(5, exciter.getNamedStates().size(), "published IEEEX1 named states");
        ...
        System.out.println("IEEEX1 PSS/E max errors: " + Arrays.toString(maximum));
        System.out.println("IEEEX1 PSS/E max-error times: " + Arrays.toString(maximumTime));
        double[] tolerances = {0.00175, 0.00385, 0.024, 0.0095, 0.185, 8.7e-5,
                0.00285, 0.00285, 0.00015, 0.060, 0.00285, 0.00050};
    ...
    private static void record(List<double[]> rows, double time,
            ...
            Machine referenceMachine, Ieeex1Exciter exciter, double initialRelativeAngle) {
