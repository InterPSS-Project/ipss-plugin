...
/** Full-solver native PSS/E AC9C comparison against Independent's DYR dialect. */
public class Ac9cIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterStates()throws Exception{
        ...
        EmbeddedTrajectoryReference reference=EmbeddedTrajectoryReference.embedded("smib-genrou-ac9c");
        ...
        System.out.printf(Locale.ROOT,"AC9C Independent max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g angleDeg=%.9g speed=%.9g eqp=%.9g psiDp=%.9g psiQpp=%.9g edp=%.9g ve=%.9g sensedV=%.9g derivative=%.9g integral=%.9g vr=%.9g vavr=%.9g vf=%.9g%n",Arrays.stream(maximum).boxed().toArray());
        System.out.println("AC9C Independent max-error times: "+Arrays.toString(maximumTime));
