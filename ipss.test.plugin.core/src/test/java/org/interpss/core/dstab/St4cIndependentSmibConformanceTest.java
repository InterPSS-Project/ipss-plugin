...
/** Native PSS/E ST4C common-profile comparison against Independent ST4C. */
public class St4cIndependentSmibConformanceTest {
    ...
    @Test void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterStates()throws Exception{
        ...
        var reference=EmbeddedTrajectoryReference.embedded("smib-genrou-st4c");
        ...
        System.out.println("ST4C Independent max errors: "+Arrays.toString(maximum));
        System.out.println("ST4C Independent max-error times: "+Arrays.toString(maximumTime));
