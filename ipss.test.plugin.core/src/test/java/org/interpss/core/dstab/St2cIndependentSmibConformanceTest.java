...
/** Native PSS/E ST2C common-profile comparison against Independent ST2C. */
public class St2cIndependentSmibConformanceTest {
    ...
    @Test void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterStates()throws Exception{
        ...
        var reference=EmbeddedTrajectoryReference.embedded("smib-genrou-st2c");
        ...
        System.out.println("ST2C Independent max errors: "+Arrays.toString(maximum));
        System.out.println("ST2C Independent max-error times: "+Arrays.toString(maximumTime));
