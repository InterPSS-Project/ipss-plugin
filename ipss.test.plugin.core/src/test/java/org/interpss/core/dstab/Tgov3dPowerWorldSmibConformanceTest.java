...
public class Tgov3dPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndGovernorStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-tgov3d", "powerworld.csv"));
        ...
        // PowerWorld stores the T5 integrator coordinate with an initialization
        ...
        for (var expected : reference.postEventSamples()) {
            ...
            powerWorld[13] += t5CoordinateOffset;
        ...
        System.out.printf(Locale.ROOT,
                "TGOV3D PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("TGOV3D PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
