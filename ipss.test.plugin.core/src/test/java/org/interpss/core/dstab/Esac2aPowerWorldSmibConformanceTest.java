...
/** Full-solver GENROU + ESAC2A comparison against the PowerWorld reference. */
@org.junit.jupiter.api.Tag("private-reference")
public class Esac2aPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-esac2a", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "ESAC2A PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("ESAC2A PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
