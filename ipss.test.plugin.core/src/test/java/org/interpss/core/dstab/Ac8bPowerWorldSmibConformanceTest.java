...
public class Ac8bPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        var context = new PSSEMultiFileLoader().loadDStab(
                ...
                CASE.resolve("SMIB_v33_genrou_ac8b_powerworld.dyr").toString());
        ...
        System.out.printf(Locale.ROOT,
                "AC8B PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("AC8B PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
