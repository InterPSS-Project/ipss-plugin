...
/** Full-solver GENROU + IEEEG1 comparison against the PowerWorld reference. */
@org.junit.jupiter.api.Tag("private-reference")
public class Ieeeg1PowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndGovernorStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-ieeeg1", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "IEEEG1 PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("IEEEG1 PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
