...
/** Full-solver GENROU + native IEEEG3/IEEEG3D comparisons against Independent. */
public class Ieeeg3dIndependentSmibConformanceTest {
    ...
    private static void record(List<double[]> rows, double time,
            ...
            Machine referenceMachine, Ieee1981Type3HydroGovernor governor,
        ...
        rows.add(new double[] {
                ...
                machine.getPsikq(), machine.getEd1(), governor.getMechanicalPower(),
                governor.getServoPosition(), governor.getGatePosition(),
                governor.getTemporaryDroopFeedback()
        });
    }
