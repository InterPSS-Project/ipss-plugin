...
/** Full-solver GENROU + EXAC1 comparison against the PowerWorld reference. */
public class Exac1PowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-exac1", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "EXAC1 PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("EXAC1 PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
