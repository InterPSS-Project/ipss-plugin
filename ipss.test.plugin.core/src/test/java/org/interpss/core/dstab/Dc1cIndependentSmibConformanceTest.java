...
/** Full-solver native PSS/E DC1C comparison against Independent. */
public class Dc1cIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterSignals()throws Exception{
        ...
        EmbeddedTrajectoryReference reference=EmbeddedTrajectoryReference.embedded("smib-genrou-dc1c");
        ...
        System.out.printf(Locale.ROOT,"DC1C Independent max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g angleDeg=%.9g speed=%.9g eqp=%.9g psiDp=%.9g psiQpp=%.9g edp=%.9g field=%.9g sensedV=%.9g vr=%.9g vf=%.9g leadLag=%.9g%n",Arrays.stream(maximum).boxed().toArray());
        System.out.println("DC1C Independent max-error times: "+Arrays.toString(maximumTime));
