...
/** Full-solver GENROU + ESST3A comparison against the PowerWorld reference. */
@org.junit.jupiter.api.Tag("private-reference")
public class Esst3aPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-esst3a", "powerworld.csv"));
        ...
        for (var expected : reference.postEventSamples()) {
            ...
            // PowerWorld exposes VM but not EFD/VG as named ESST3A states.
            ...
            powerWorld[14] = powerWorld[10] * row[17];
            powerWorld[15] = Math.min(exciter.vgmax, exciter.kg * powerWorld[14]);
        ...
        System.out.printf(Locale.ROOT,
                "ESST3A PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("ESST3A PowerWorld max-error times: "
