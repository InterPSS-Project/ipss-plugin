...
/** Full-solver native PSS/E ESDC1A/ESDC2A comparisons against Independent. */
public class Esdc1aIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterSignals(String model)
            throws Exception {
        ...
        System.out.println(model + " Independent max-error times: "
