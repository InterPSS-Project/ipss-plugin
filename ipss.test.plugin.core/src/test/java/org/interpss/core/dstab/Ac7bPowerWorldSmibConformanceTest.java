...
public class Ac7bPowerWorldSmibConformanceTest {
    ...
    @Test
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndAllExciterStates() throws Exception {
        IpssCorePlugin.init();
        var context = new PSSEMultiFileLoader().loadDStab(
                CASE.resolve("SMIB_v33.raw").toString(),
                CASE.resolve("SMIB_v33_genrou_ac7b_powerworld.dyr").toString());
        ...
        System.out.printf(Locale.ROOT,
                "AC7B PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("AC7B PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
