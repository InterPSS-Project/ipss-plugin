...
/** Full-solver GENROU + HYGOV comparison against the PowerWorld reference. */
@org.junit.jupiter.api.Tag("private-reference")
public class HygovPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndGovernorStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-hygov", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "HYGOV PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("HYGOV PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
