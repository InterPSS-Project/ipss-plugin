...
/** Full-solver GENROU + ESAC3A comparison against the PowerWorld reference. */
public class Esac3aPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-esac3a", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "ESAC3A PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("ESAC3A PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
