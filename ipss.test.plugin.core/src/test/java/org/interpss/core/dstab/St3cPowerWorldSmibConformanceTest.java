...
public class St3cPowerWorldSmibConformanceTest {
    ...
    @Test void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates()throws Exception{
        ...
        var reference=PowerWorldCsvReference.read(Path.of("testData","reference","powerworld","smib-genrou-st3c","powerworld.csv"));
        ...
        System.out.println("ST3C PowerWorld max errors: "+Arrays.toString(maximum));
        System.out.println("ST3C PowerWorld max-error times: "+Arrays.toString(maximumTime));
