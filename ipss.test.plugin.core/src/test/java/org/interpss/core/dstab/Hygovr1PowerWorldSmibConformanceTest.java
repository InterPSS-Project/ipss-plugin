...
public class Hygovr1PowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesBoundaryMachineAndAllTenGovernorStates() throws Exception {
        ...
        var context = new PSSEMultiFileLoader().loadDStab(
                ...
                CASE.resolve("SMIB_v33_genrou_hygovr1_powerworld.dyr").toString());
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-hygovr1", "powerworld.csv"));
        ...
        System.out.println("HYGOVR1 PowerWorld max errors: " + Arrays.toString(maximum));
        System.out.println("HYGOVR1 PowerWorld max-error times: " + Arrays.toString(maximumTime));
        String[] label = {
