...
/** Trajectory comparison against the common non-limiter subset of ANDES 2.0.0 EXST1. */
public class Exst1AndesSmibConformanceTest {
    ...
    private static final Path REFERENCE = Path.of("src", "test", "resources", "reference",
            "andes", "exst1-smib-line-trip.csv");
    ...
    void lineTripTrajectoryMatchesAndes() throws Exception {
        ...
        var context = new PSSEMultiFileLoader().loadDStab(
                ...
                CASE.resolve("SMIB_v33_genrou_exst1.dyr").toString());
        ...
        assertTrue(algorithm.initialization(), "EXST1 dynamic initialization");
        assertTrue(algorithm.performSimulation(), "EXST1 line-trip simulation");
        ...
        System.out.printf(java.util.Locale.ROOT,
                "EXST1 ANDES SMIB max errors: speed=%.9g@%.4f efd=%.9g@%.4f "
                        + "v1=%.9g@%.4f v2=%.9g@%.4f%n",
        ...
        System.out.printf(java.util.Locale.ROOT,
                "EXST1 ANDES internal max errors: sensed=%.9g@%.4f vi=%.9g@%.4f "
                        + "limitedVi=%.9g@%.4f ll=%.9g@%.4f vr=%.9g@%.4f "
                        + "feedback=%.9g@%.4f%n",
    ...
    private static List<double[]> readReference() throws Exception {
        ...
        for (String line : EmbeddedCsvTrajectoryValues.lines("exst1-smib-line-trip.csv")) {
        ...
        public boolean onSimuEvent(DStabSimuEvent event) {
            ...
            if (accepted && event.getType() == DStabSimuEvent.PlotStepMachineStates
                ...
                internal.add(new double[] {exciter.getSensedVoltage(),
                        ...
                        exciter.getLeadLagOutput(), exciter.getRegulatorOutput(),
