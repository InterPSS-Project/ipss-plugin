...
/** Native PSS/E ST6B common-profile comparison against Independent ST6B. */
public class St6bIndependentSmibConformanceTest {
    ...
    @Test void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterStates()throws Exception{
        ...
        var reference=EmbeddedTrajectoryReference.embedded("smib-genrou-st6b");
        ...
        System.out.println("ST6B Independent max errors: "+Arrays.toString(maximum));
        System.out.println("ST6B Independent max-error times: "+Arrays.toString(maximumTime));
