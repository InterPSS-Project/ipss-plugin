...
/** Full-solver native PSS/E DC2C comparison against PowerWorld. */
@org.junit.jupiter.api.Tag("private-reference")
public class Dc2cPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterSignals()throws Exception{
        ...
        PowerWorldCsvReference reference=PowerWorldCsvReference.read(Path.of("testData","reference","powerworld","smib-genrou-dc2c","powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,"DC2C PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g angleDeg=%.9g speed=%.9g eqp=%.9g psiDp=%.9g psiQpp=%.9g edp=%.9g field=%.9g sensedV=%.9g vr=%.9g vf=%.9g leadLag=%.9g%n",Arrays.stream(maximum).boxed().toArray());
        System.out.println("DC2C PowerWorld max-error times: "+Arrays.toString(maximumTime));
