...
public class Ieeet1PowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-ieeet1", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "IEEET1 PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("IEEET1 PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
