...
/** Full-solver native PSS/E DC4B comparison against Independent. */
public class Dc4bIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndExciterStates()throws Exception{
        ...
        EmbeddedTrajectoryReference reference=EmbeddedTrajectoryReference.embedded("smib-genrou-dc4b");
        ...
        System.out.println("DC4B Independent max errors: "+Arrays.toString(maximum));
        System.out.println("DC4B Independent max-error times: "+Arrays.toString(maximumTime));
