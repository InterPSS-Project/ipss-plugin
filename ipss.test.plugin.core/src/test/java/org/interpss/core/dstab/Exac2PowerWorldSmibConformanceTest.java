...
/** Full-solver GENROU + EXAC2 comparison against the PowerWorld reference. */
public class Exac2PowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-exac2", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "EXAC2 PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("EXAC2 PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
