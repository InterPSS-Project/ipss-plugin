...
/** Full-solver GENROU + native GASTWDD comparison against Independent. */
public class GastwddIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndGovernorStates() throws Exception {
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("smib-genrou-gastwdd");
        ...
        System.out.println("GASTWDD Independent max errors: " + Arrays.toString(maximum));
        System.out.println("GASTWDD Independent max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
