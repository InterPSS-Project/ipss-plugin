...
/** Full-solver GENROU + ESST1A + PSS5C comparison against Independent. */
public class Pss5cIndependentSmibConformanceTest {
    ...
    @Test
    void threeCycleFaultMatchesIndependentBoundaryAndPublishedPssResponse() throws Exception {
        IpssCorePlugin.init();
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("smib-genrou-esst1a-pss5c");
        ...
        System.out.println("PSS5C Independent max errors: " + Arrays.toString(maximum));
        System.out.println("PSS5C Independent max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
