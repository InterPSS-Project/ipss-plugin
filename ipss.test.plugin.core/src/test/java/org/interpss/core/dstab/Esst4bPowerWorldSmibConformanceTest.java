...
/** Full-solver GENROU + ESST4B comparison against the PowerWorld reference. */
public class Esst4bPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-esst4b", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "ESST4B PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("ESST4B PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
