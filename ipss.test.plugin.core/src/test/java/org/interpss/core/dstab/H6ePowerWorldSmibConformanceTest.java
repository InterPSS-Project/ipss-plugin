...
public class H6ePowerWorldSmibConformanceTest {
    ...
    @Test
    void nonlinearKaplanProfileMatchesPowerWorldBoundaryMachineAndAllNineStates()
            throws Exception {
        IpssCorePlugin.init();
        var context = new PSSEMultiFileLoader().loadDStab(
                CASE.resolve("SMIB_v33.raw").toString(),
                CASE.resolve("SMIB_v33_genrou_h6e_powerworld.dyr").toString());
        ...
        System.out.println("H6E PowerWorld max errors: " + Arrays.toString(maximum));
        System.out.println("H6E PowerWorld max-error times: " + Arrays.toString(maximumTime));
        String[] label = {
