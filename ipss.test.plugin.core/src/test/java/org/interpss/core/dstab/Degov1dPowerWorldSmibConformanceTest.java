...
/** Full-solver GENROU + native DEGOV1D comparison against PowerWorld. */
public class Degov1dPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndGovernorStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-degov1d", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "DEGOV1D PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("DEGOV1D PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
    ...
    private static void record(List<double[]> rows, double time,
        ...
        // PowerWorld uses an observable-canonical realization of
