...
/** Full-solver GENROU + native GASTD comparison against Independent. */
public class GastdIndependentSmibConformanceTest {
    ...
    void threeCycleFaultMatchesIndependentBoundaryMachineAndGovernorStates() throws Exception {
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("smib-genrou-gastd");
        ...
        System.out.printf(Locale.ROOT,
                "GASTD Independent max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("GASTD Independent max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
