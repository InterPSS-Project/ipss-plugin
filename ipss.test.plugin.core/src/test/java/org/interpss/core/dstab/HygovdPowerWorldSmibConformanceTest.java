...
/** Full-solver GENROU + HYGOVD comparison against the native PowerWorld model. */
public class HygovdPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndGovernorStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-hygovd", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "HYGOVD PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("HYGOVD PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
