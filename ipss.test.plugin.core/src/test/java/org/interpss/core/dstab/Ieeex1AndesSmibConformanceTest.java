...
public class Ieeex1AndesSmibConformanceTest {
    ...
    private static final Path REFERENCE = Path.of("src", "test", "resources",
            "reference", "andes", "ieeex1-smib-line-trip.csv");
    ...
    void lineTripTrajectoryMatchesAndes() throws Exception {
        ...
        assertTrue(algorithm.performSimulation(), "IEEEX1 line-trip simulation");
        ...
        System.out.printf(java.util.Locale.ROOT,
                "IEEEX1 ANDES SMIB max errors: speed=%.9g efd=%.9g v1=%.9g v2=%.9g%n",
    ...
    private static List<double[]> readReference() throws Exception {
        ...
        for (String line : EmbeddedCsvTrajectoryValues.lines("ieeex1-smib-line-trip.csv")) {
