...
/** Diagnostic REGCA1/REECA1/Type-3 trajectory comparison against Independent. */
public class Type3WindIndependentTrajectoryTest extends CorePluginTestSetup {
    private static final double STEP = 0.0005;

    @Test
    void threeCyclePoiFaultRetainsIndependentVendorDifferenceDiagnostic() throws Exception {
        ...
        assertTrue(algorithm.initialization(), "Type-3 Independent benchmark initialization");
        ...
        EmbeddedTrajectoryReference reference = EmbeddedTrajectoryReference.embedded("type3-wind-bus1062");
        ...
        int[] field = {
                ...
                // Independent State 5 is the inactive QFLAG=0 Tiq path for this
        ...
        System.out.printf(Locale.ROOT,
                "Type-3 Independent max errors: v1=%.9g v2=%.9g v3=%.9g pMW=%.9g "
