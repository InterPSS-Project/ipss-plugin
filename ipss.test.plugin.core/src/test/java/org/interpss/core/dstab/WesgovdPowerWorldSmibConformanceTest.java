...
/** Full-solver GENROU + WESGOVD comparison against PowerWorld. */
public class WesgovdPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndGovernorStates() throws Exception {
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-wesgovd", "powerworld.csv"));
        ...
        System.out.println("WESGOVD PowerWorld max errors: " + Arrays.toString(maximum));
        System.out.println("WESGOVD PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
    ...
    private static void record(List<double[]> rows, double time,
        ...
        rows.add(new double[] {
                ...
                // PowerWorld's canonical second-order "Valve" integrator.
