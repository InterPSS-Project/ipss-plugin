...
/** Full-solver GENROU + ESAC8B comparison against the PowerWorld reference. */
public class Esac8bPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineAndExciterStates() throws Exception {
        ...
        var context = new PSSEMultiFileLoader().loadDStab(
                ...
                CASE.resolve("SMIB_v33_genrou_esac8b_powerworld.dyr").toString());
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                "testData", "reference", "powerworld", "smib-genrou-esac8b", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "ESAC8B PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("ESAC8B PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
