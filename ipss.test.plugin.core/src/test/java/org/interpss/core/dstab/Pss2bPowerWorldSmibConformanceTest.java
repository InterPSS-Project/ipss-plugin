...
/** Full-solver GENROU + ESST1A + PSS2B comparison against PowerWorld. */
public class Pss2bPowerWorldSmibConformanceTest {
    ...
    void threeCycleFaultMatchesPowerWorldBoundaryMachineExciterAndPssStates()
        ...
        PowerWorldCsvReference reference = PowerWorldCsvReference.read(Path.of(
                ...
                "smib-genrou-esst1a-pss2b", "powerworld.csv"));
        ...
        System.out.printf(Locale.ROOT,
                "PSS2B PowerWorld max errors: v1=%.9g v2=%.9g pMW=%.9g qMvar=%.9g "
        ...
        System.out.println("PSS2B PowerWorld max-error times: " + Arrays.toString(maximumTime));
        double[] tolerance = {
