...
public class CIMDirectParserTest extends CorePluginTestSetup {
    ...
    public void testMicroGrid_EQ_TP_BusBranchCounts() throws Exception {
        AclfNetwork net = new SimpleCIMDirectParser().parse(new String[]{MG_BE_EQ, MG_BE_TP});
    ...
    public void testMicroGrid_MultiFile_LoadsAndSwing() throws Exception {
        AclfNetwork net = new SimpleCIMDirectParser().parse(
        ...
        assertTrue(SimpleCIMDirectParser.getLastLoadCount() > 0);
    }
    ...
    public void testMiniGrid_3WTransformers() throws Exception {
        AclfNetwork net = new SimpleCIMDirectParser().parse(new String[]{MN_EQ, MN_TP, MN_SSH});
    ...
    public void testIEEE118_CIMHub() throws Exception {
        AclfNetwork net = new SimpleCIMDirectParser().parse(TD + "IEEE118_CIM.xml");
        ...
        assertEquals(99, SimpleCIMDirectParser.getLastLoadCount(), "Loads should match MATPOWER");
    ...
    public void testBoundaryNodesSkipped() throws Exception {
        ...
        AclfNetwork withBd = new SimpleCIMDirectParser().parse(new String[]{
                MG_BE_EQ, MG_BE_TP, TD + "MicroGrid_T4_BE_EQ_BD_V2.xml", TD + "MicroGrid_T4_BE_TP_BD_V2.xml"
        });
        AclfNetwork withoutBd = new SimpleCIMDirectParser().parse(new String[]{MG_BE_EQ, MG_BE_TP});
