...
import com.interpss.dstab.cache.StateMonitor.MonitorRecType;
import com.interpss.simu.SimuContext;
import com.interpss.simu.SimuCtxType;

public class TestRelayUnderVoltLoadShed extends DStabTestSetupBase{
	...
	public void test_IEEE9Bus_Dstab() throws InterpssException{
	    ...
	    LoadUVShedRelayModel uvls = new LoadUVShedRelayModel(bus5, "1");
	    ...
	    uvls.setRelaySetPoints(settings);
...
//	    System.out.println(dsNet.net2String());
		...
		sm.addNewMonitor("Bus5", MonitorRecType.BusTotalLoadShedPU);
		...
		System.out.println("Bus5 shed load = \n" + sm.toCSVString(sm.getBusTotalLoadShedPUTable()));
		
		System.out.println("Bus 5 load = "+bus5.calStaticLoad().toString());
		
		assertTrue(uvls.getTrippedFraction()==0.1);
