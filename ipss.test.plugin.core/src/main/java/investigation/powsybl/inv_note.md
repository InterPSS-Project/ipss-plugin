...
| POW-2 | [`done/Ieee14CompletedMismatchInvestigation`](done/Ieee14CompletedMismatchInvestigation.java) | `parser/IEEE_14_bus_completed*.raw` + RAWX twin | ≈3.01–3.26 @ Bus12/Bus14 | Closed: WATL 2T residual; MTDC fixture-invalid |
